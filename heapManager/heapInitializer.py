...
class HeapInitializer:
    ...
    @staticmethod
    def partial_entropy_iterable(value):
    ...
    def init_gain_H(self):
        ...
        part1 = self.mui * self.partial_entropy_iterable(self.pij) + self.muj * self.partial_entropy_iterable(self.pji)
        part2 = self.mui * self.partial_entropy_iterable(self.pii_new)
        part3 = self.muj * self.partial_entropy_iterable(self.pjj_new)
